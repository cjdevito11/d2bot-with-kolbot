...
function LoadConfig() {
	...
	*/
	...
	// Chicken settings
	Config.LifeChicken = 2; // Exit game if life is less or equal to designated percent.
	 ...
	 */
	Config.Inventory[0] = [1,0,1,1,1,1,1,1,1,1];
	Config.Inventory[1] = [1,0,1,1,1,1,1,1,1,1];
	...
	Config.AttackSkill[1] = 273; // Primary skill to bosses.
	Config.AttackSkill[2] = 256; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[1] is untimed skill.
	...
	Config.DodgeRange = 25; // Distance to keep from monsters.
	...
	Config.AggressiveCloak = true; // Move into Cloak range or cast if already close
