...
function main() {
	...
	this.andariel = function () {
		say("Welcome to my rush. If at any time the rush stops, try coming in and out of TP!")
	...
	this.summoner = function () {
		...
		Pather.makePortal();
		Attack.securePosition(me.x, me.y, 25, 3000);
		say("Up! If it wont let you in, Talk To Cain!");
		while (!this.playerIn()) {
			Pather.moveToUnit(spot);
			Attack.securePosition(me.x, me.y, 50, 1000);
			delay(250);
		}
		...
		Attack.kill(250);
		Attack.securePosition(me.x, me.y, 50, 1000, true);
		say("Dead!");
	...
	this.duriel = function () {
		...
		say("In");
		say("If you can't get in, Talk To Cain!");
		while (!this.playerIn()) {
			//Pather.moveToPreset(me.area, 2, 152, 0, -5);
			delay(100);
		}
		say("Use Staff and go in first!");
		while (this.playerIn()) {
			delay(100);
		}
	...
	this.mephisto = function () {
		...
		Pather.makePortal();
		delay(2000);
		say("Up! If you can't get in, Talk To Cain!");
...
MainLoop:
	...
	this.izual = function () {
		...
		Pickit.pickItems();
		say("Talk to Izual and go back to town!/f lamesen");
		Pather.moveToUnit(returnSpot);
