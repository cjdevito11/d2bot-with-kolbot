...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["Proteus"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	Config.ScanShrines = ["14,15,13,12,11,10,9,8,7,6,5,4,3"];
	...
	Config.AutoSkill.Build = [[80,20,true],[70,20,true],[75,20,true]];
