...
*/
	...
	Config.Leader = "HotAsIce"; // Leader's ingame character name. Leave blank to try auto-detection (works in AutoBaal, Wakka, MFHelper)
	...
	Scripts.ClearAnyArea = false; // Clear any area. Uses Config.ClearType to determine which type of monsters to kill.
		Config.ClearAnyArea.AreaList = [124]; // List of area ids to clear. See sdk/areas.txt
	...
	// Town settings
	Config.HealHP = 30; // Go to a healer if under designated percent of life.
